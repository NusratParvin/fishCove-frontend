        ...
        >
            ...
            <div className="flex justify-between items-start w-full">
              <div className="flex items-center w-full mb-3">
                ...
                <div className="ml-3 flex-grow space-y-2">
                  <Skeleton className="w-24 h-6 rounded-lg">
                    <div className="w-24 h-6 bg-default-300 rounded-lg"></div>
                  </Skeleton>
              ...
              <div className="flex items-center gap-1">
                <Skeleton className="w-6 h-6 rounded-lg">
                  <div className="w-6 h-6 bg-default-300 rounded-lg"></div>
                </Skeleton>
                <Skeleton className="w-8 h-8 rounded-lg">
                  <div className="w-8 h-8 bg-default-300 rounded-lg"></div>
                </Skeleton>
              </div>
            </div>

            <Skeleton className="w-full h-6 rounded-lg">
              <div className="w-full h-6 bg-default-300 rounded-lg"></div>
            </Skeleton>
          </CardHeader>
          ...
          <CardBody className="p-0 space-y-4">
            <Skeleton className="rounded-lg h-64 w-full">
              <div className="h-64 w-full bg-default-300 rounded-lg"></div>
            </Skeleton>
            <Skeleton className="w-full h-20 rounded-lg">
              <div className="w-full h-20 bg-default-300 rounded-lg"></div>
            </Skeleton>
          </CardBody>
          ...
          <CardFooter className="flex justify-between items-center space-x-4 p-5">
            <div className="flex space-x-3">
              <Skeleton className="w-12 h-6 rounded-lg">
                <div className="w-12 h-6 bg-default-300 rounded-lg"></div>
              </Skeleton>
              <Skeleton className="w-12 h-6 rounded-lg">
                <div className="w-12 h-6 bg-default-300 rounded-lg"></div>
              </Skeleton>
